        ...
        <form className='p-5 block justify-center'>
          <FormRow>
            <div className='flex flex-col w-1/3'>
              ...
              <input type='text' id='nombre' className='mx-5 p-2 dark:text-teal-950 border border-fuchsia-950 dark:border-teal-50 focus:outline-none' />
            </div>
            <div className='flex flex-col w-1/3'>
              <label htmlFor='telefono' className='px-5'>
                Teléfono
              </label>
              <input type='text' id='telefono' className='mx-5 p-2 dark:text-teal-950 border border-fuchsia-950 dark:border-teal-50 focus:outline-none' />
            </div>
          </FormRow>
          <FormRow>
          <div className='flex flex-col w-1/3'>
          ...
          <FormRow>
            ...
            <div className='flex flex-col w-1/3'>
              ...
              <input type='date' id='diaDeSalida' className='mx-5 p-2 dark:text-teal-950 border border-fuchsia-950 dark:border-teal-50 focus:outline-none' />
            </div>
          </FormRow>
          <FormRow>
            <div className='flex flex-col w-1/3'>
