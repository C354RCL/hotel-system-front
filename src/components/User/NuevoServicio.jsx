  ...
  return (
    <div className='p-10 w-full place-content-center'>
        ...
        <div className='flex justify-center'>
          <a href='#' className='bg-teal-700 hover:bg-teal-950 text-white font-bold py-2 px-4 m-6 rounded-lg'>
              <img src={reloj} alt='Por horas' className='w-1/2 m-auto p-2' />
              <h1 className='text-center text-2xl'>Por horas</h1>
          </a>
          <a href='#' className='bg-teal-200 hover:bg-teal-500 text-teal-700 font-bold py-2 px-4 m-6 rounded-lg'>
